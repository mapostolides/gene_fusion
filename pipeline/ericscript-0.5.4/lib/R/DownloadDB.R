...
## download gene data
system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "genepos.xml"), version, "| sort -u - >", file.path(tmpfolder, "genepos.txt")))
system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "geneinfo.xml"), version, "| sort -u - >", file.path(tmpfolder, "geneinfo.txt")))
system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "exonstartend.xml"), version, "| sort -u - >", file.path(tmpfolder, "exonstartend.txt")))
system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "strand.xml"), version, "| sort -u - >", file.path(tmpfolder, "strand.txt")))
system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "transcripts.xml"), version, "| sort -u - >", file.path(tmpfolder, "transcripts.txt")))
system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "transcripts_cdna.xml"), version, ">", file.path(tmpfolder, "transcripts.fa")))
if (myrefid == "homo_sapiens") {
  system(paste("perl", file.path(ericscriptfolder, "lib", "perl", "retrievefrombiomart.pl"), file.path(tmpfolder, "paralogs.xml"), "| sort -u - >", file.path(tmpfolder, "paralogs.txt")))
  acc.chrs <- c(1:22, "X", "Y")
  cat (acc.chrs, file = file.path(tmpfolder, "chrlist"), sep = "\n")
}
## download seq data
download.file(file.path("ftp://ftp.ensembl.org/pub", paste("release-", version, sep = ""), "fasta", myrefid, "dna", myrefid.path), destfile = file.path(tmpfolder, "seq.fa.gz"), quiet = T)
