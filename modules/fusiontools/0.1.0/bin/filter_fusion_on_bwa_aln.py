...
parser.add_argument('--cff_file', action='store', help='CFF file, can be .cff or cff.reann', required=True)
parser.add_argument('--bwa_sam', action='store', help='bwa alignment of the reann file converted fasta', required=True)
